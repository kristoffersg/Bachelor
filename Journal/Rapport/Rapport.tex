...
%%% % % % % % % PAKKER % % % % % % % % % % % % % % % % % % % % % % % 
 ...
 \usepackage{rotating}
   ...
   % \usepackage{clock} % Til at lave et sejt analogt ur 
...
%\definecolor{ThemeColor}{RGB}{224, 32, 28} % Red
\definecolor{ThemeColor}{RGB}{255,110,0} % Orange
...
\externaldocument[Design-]{../Designdokument/Designdokument}
\externaldocument[Test-]{../Accepttestspecifikation/Accepttestspecifikation}
...
\fancyhead[RO]{\includegraphics[height=40pt]{header}} % Insert picture in right side of header
...
\input{Kapitler/Opgavebeskrivelse}
\input{Kapitler/Kravspecifikation}
\input{Kapitler/Projektplan}
